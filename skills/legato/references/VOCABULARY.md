<!-- Copied (below this header) from emilkowalski/skills — animation-vocabulary/SKILL.md, with the
     upstream YAML frontmatter removed; body otherwise verbatim.
     MIT License, Copyright (c) 2026 Emil Kowalski. See LICENSE in this directory. -->
